namespace MongoRepository
{
    ...
    /// <summary>
    /// Internal miscellaneous LegacyUtility functions.
    /// </summary>
    internal static class LegacyUtil<U>
    {
        /// <summary>
        ...
        public static MongoCollection<T> GetCollectionFromConnectionString<T>(string connectionString)
            where T : IEntity<U>
        {
            return LegacyUtil<U>.GetCollectionFromConnectionString<T>(connectionString, GetCollectionName<T>());
        }
        ...
        public static MongoCollection<T> GetCollectionFromConnectionString<T>(string connectionString, string collectionName)
            where T : IEntity<U>
        {
            return LegacyUtil<U>.GetDatabaseFromUrl(new MongoUrl(connectionString))
        ...
        public static MongoCollection<T> GetCollectionFromUrl<T>(MongoUrl url)
            where T : IEntity<U>
        {
            return LegacyUtil<U>.GetCollectionFromUrl<T>(url, GetCollectionName<T>());
        }
        ...
        public static MongoCollection<T> GetCollectionFromUrl<T>(MongoUrl url, string collectionName)
            where T : IEntity<U>
        {
            return LegacyUtil<U>.GetDatabaseFromUrl(url)
                .GetCollection<T>(collectionName);
        }
